...
export default function HomeSection() {
  const images = [
    { src: '/src/01.jpg', text: '20% OFF!' },
    { src: '/src/02.webp', text: 'Free Shipping!' },
    { src: '/src/03.webp', text: 'Organic Product!' },
    { src: '/src/04.webp', text: 'Fresh Product!' },
    { src: '/src/05.webp', text: 'Buy and get Gift!' },
    { src: '/src/06.jpg', text: '10% OFF!' },
    { src: '/src/07.webp', text: 'Replace Waranty!' },
    { src: '/src/08.webp', text: 'Refund in 7 Days!' },
  ];
